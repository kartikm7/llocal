...
const ButtonVariants = cva('', {
  variants: {
    variant: {
      ...
      primary: 'hover:scale-95 disabled:transition-none disabled:opacity-50 opacity-60 hover:opacity-100 transition-all bg-background bg-opacity-30 p-2 px-3 rounded-xl',
