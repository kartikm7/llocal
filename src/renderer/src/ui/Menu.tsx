...
const Root = MenuProvider.Root
const Trigger = MenuProvider.Trigger

const Content = ({ className, children, align = "center", ...props }: MenuProvider.DropdownMenuContentProps): React.ReactElement => {
...
const Item = ({ className, variant, children, ...props }: MenuItemProps): React.ReactElement => {
